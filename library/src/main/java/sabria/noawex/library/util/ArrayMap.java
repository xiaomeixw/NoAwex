...
public class ArrayMap<K, V> implements Map<K, V> {
    ...
    private int mSize;
    private Iterable<V> mIterable = createIterable();

    private Iterable<V> createIterable() {
    ...
    public void putAll(Map<? extends K, ? extends V> map) {
        ArrayMap<? extends K, ? extends V> array = (ArrayMap<? extends K, ? extends V>) map;
